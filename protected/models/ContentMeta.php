...
//			array('bg_color', 'length', 'max'=>100),
			...
			array('idmcontent, idcontent, meta_key, meta_value', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idmcontent',$this->idmcontent);
